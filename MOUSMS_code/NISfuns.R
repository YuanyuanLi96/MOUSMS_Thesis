...
###########################################################################
adaptINIS <- function(data, testdata=NULL, lambda.pen.list=NULL, folds=NULL, quant=NULL,
                      kfold=NULL, knots=NULL,  eps0=1e-6, DOISIS=TRUE, maxloop=10, trace=FALSE, detailed=FALSE){
  t0=proc.time()[1]
